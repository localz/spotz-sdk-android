...
public class OnBeaconDiscoveryFoundReceiver extends BroadcastReceiver {
    ...
    private void inSpot(Context context, SpotzGetResponse spotzGetResponse, BleData bleData) {
        ...
        ActivityReportPostRequest records = new ActivityReportPostRequest();
        records.addRecord(new Date(), ActivityType.SPOTZ_ENTER.getName(),
                beaconId, spotzGetResponse._id);
        new ActivityReportTask().execute(records);
